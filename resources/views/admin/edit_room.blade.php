 ...
 @if (Auth::guest())
  ...
  <body>
    <div class="container">
      ...
      <form method="post" action="{{ route('room_update', $id) }}" enctype="multipart/form-data">
  {{ csrf_field() }}  
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="room_no" value="{{$passport->room_no}}">
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="condition" value="{{$passport->condition}}">
            </div>
          </div>
<!--
         <div class="row">
